                ...
                <div ref="flagOptions" style={{ fontSize: `${optionsSize}px`, color: '#4d4d4d' }}
                    ...
                    {(this.state.filter ? this.state.filteredCountries : this.state.countries).map(countryCode =>
                        ...
                        <div className={`flag-option ${this.props.showOptionLabel ? 'has-label' : ''}`}
                             key={countryCode} onClick={() => this.onSelect(countryCode)}>
								<span className="country-flag"
                                    ...
                                    <span
                                        className="country-label">{this.props.customLabels[countryCode] || countries[countryCode]}</span>
                                    }
								</span>
                        </div>
                    )}
...
export default ReactCountryAutocomplete;
