...
var _lightBlue = require('material-ui/colors/lightBlue');
...
var ReactCountryAutocomplete = function (_Component) {
    _inherits(ReactCountryAutocomplete, _Component);

    function ReactCountryAutocomplete(props) {
        _classCallCheck(this, ReactCountryAutocomplete);
        ...
        _this.theme = (0, _styles.createMuiTheme)({
            palette: {
                type: _this.props.theme || 'light',
                primary: _lightBlue2.default
            }
        });
    ...
    ReactCountryAutocomplete.prototype.toggleOptions = function toggleOptions() {
        !this.state.disabled && this.setState({
            openOptions: !this.state.openOptions
        });
    };

    ReactCountryAutocomplete.prototype.closeOptions = function closeOptions(event) {
    ...
    ReactCountryAutocomplete.prototype.onSelect = function onSelect(countryCode) {
        this.setState({
    ...
    ReactCountryAutocomplete.prototype.updateSelected = function updateSelected(countryCode) {
    ...
    ReactCountryAutocomplete.prototype.filterSearch = function filterSearch(evt) {
        var _this2 = this;
    ...
    ReactCountryAutocomplete.prototype.componentDidMount = function componentDidMount() {
        !this.props.disabled && window.addEventListener("click", this.closeOptions);
    };

    ReactCountryAutocomplete.prototype.componentWillUnmount = function componentWillUnmount() {
        !this.props.disabled && window.removeEventListener("click", this.closeOptions);
    };

    ReactCountryAutocomplete.prototype.render = function render() {
        var _this3 = this;

        var isSelected = this.state.selected || this.state.defaultCountry;
        var selectedColor = this.props.selectedColor || '#333333';
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { ref: 'selectedFlag', style: { fontSize: selectedSize + 'px', color: '' + selectedColor },
                    ...
                    _react2.default.createElement(
                        'span',
                        { className: 'arrow-down ' + (this.props.disabled ? 'hidden' : ''), style: { color: '' + selectedColor } },
                        '\u25BE'
                    )
                ),
                this.state.openOptions && _react2.default.createElement(
                    'div',
                    { ref: 'flagOptions', style: { fontSize: optionsSize + 'px', color: '#4d4d4d' },
                        className: 'flag-options ' + alignClass },
                    this.props.searchable && _react2.default.createElement(
                        'div',
                        { className: 'filterBox', style: { marginLeft: 10 } },
                        _react2.default.createElement(_TextField2.default, { id: 'uniqueIdGoesHere',
                            autoFocus: true,
                            placeholder: 'Search',
                            ref: 'filterText',
                    ...
                    (this.state.filter ? this.state.filteredCountries : this.state.countries).map(function (countryCode) {
                        return _react2.default.createElement(
                            'div',
                            { className: 'flag-option ' + (_this3.props.showOptionLabel ? 'has-label' : ''),
                                key: countryCode, onClick: function onClick() {
    ...
    return ReactCountryAutocomplete;
}(_react.Component);

ReactCountryAutocomplete.defaultProps = {
    selectedSize: 16,
    optionsSize: 14,
...
ReactCountryAutocomplete.propsType = {
...
exports.default = ReactCountryAutocomplete;
